...
if (isset($_GET["action"]) && ($_GET["action"] == "del")) {
    ...
    $sql_query = "DELETE FROM n_news  WHERE n_id=?";
...
<div class="container rounder-4 p-3 bg-white shadow">
    <div class="pt-2 pb-0">
        ...
        <h2 class="text-center">最新消息管理系統-刪除資料<a href="./table.php" class="btn btn-success" style="margin-left: 3rem;">回主畫面</a></h2>

        <form action="./03_branch_delete.php" method="get">
            <div class="container">
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>開始時間</td>
                                    <td><p><?php echo $n_start; ?></p></td>
                                </tr>
                                <tr>
                                    <td>結束時間</td>
                                    <td><p><?php echo $n_end; ?></p></td>
                                </tr>
                                <tr>
                                    <td>標題</td>
                                    <td><p><?php echo $n_title; ?></p></td>
                                </tr>
                                <tr>
                                    <td>內容</td>
                                    <td><p><?php echo $n_content; ?></p></td>
                                </tr>

                                <tr>
                                    <td>類型</td>
                                    <td><p><?php echo $n_type; ?></p></td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center">
                                        <input name="action" type="hidden" value="del">
                                        <button type="submit" class="btn btn-primary" value="刪除資料">刪除資料<?php echo $n_id;?></button>
                                        <input name="n_id" type="hidden" value="<?php echo $n_id;?>">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
